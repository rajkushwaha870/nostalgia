...
export const VintageRadio: React.FC = () => {
  ...
  return (
    <div className="relative group select-none z-20 transition-transform duration-500 hover:scale-[1.03]">
      ...
      <div className="absolute -inset-4 bg-gradient-to-r from-[#E5AD54]/20 via-[#B9472F]/20 to-transparent blur-xl rounded-full opacity-70 group-hover:opacity-100 transition-opacity duration-500" />

      {/* Radio Container */}
      <div className="relative w-72 sm:w-80 md:w-88 bg-gradient-to-b from-[#3A2116] via-[#24150F] to-[#1A0E0A] border-4 border-[#C88A3D]/40 rounded-lg p-3.5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] backdrop-blur-md">
        ...
        <div className="h-2 w-full bg-gradient-to-r from-[#C88A3D]/40 via-[#E5AD54] to-[#C88A3D]/40 rounded-t mb-2 flex items-center justify-between px-2">
          <span className="text-[8px] font-mono tracking-widest text-[#24150F] font-bold">
            NATIONAL TRANSISTOR • 1978
          </span>
        ...
        <div className="grid grid-cols-12 gap-3 items-stretch">
          ...
          <div className="col-span-6 bg-[#1F120B] rounded border border-[#C88A3D]/20 p-2 relative overflow-hidden shadow-inner flex flex-col justify-between">
            ...
            <div className="mt-2 text-center border-t border-[#C88A3D]/20 pt-1">
              <span className="text-[9px] font-serif font-bold text-[#E5AD54] tracking-wider uppercase">
                Murphy Gold
              </span>
            </div>
          </div>
          ...
          <div className="col-span-6 flex flex-col justify-between space-y-2">
            ...
            <div className="bg-[#24150F] p-2 rounded border border-[#C88A3D]/20 flex items-center justify-between">
              ...
              >
                ...
                />
                <span className="text-[7px] text-[#F1D7A3]/60 mt-0.5 font-mono">POWER</span>
              </button>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[7px] text-[#F1D7A3]/60 mt-0.5 font-mono">VOL</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div
                  ...
                  title="Turn Tuning Knob"
                >
                  <div className="w-1 h-2.5 bg-[#C94B32] rounded-full transform -translate-y-1.5" />
                </div>
                <span className="text-[7px] text-[#F1D7A3]/60 mt-0.5 font-mono">TUNE</span>
              </div>
            </div>
